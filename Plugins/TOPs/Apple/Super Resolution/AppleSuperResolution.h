...
private:
	...
	int scaleFactorFromMenuIndex(int scaleIndex) const;
	const char* inputTypeLabel(int inputTypeIndex) const;
	...
	int lastRequestedScaleFactor = 4;
	int lastInputTypeIndex = 0;
};
